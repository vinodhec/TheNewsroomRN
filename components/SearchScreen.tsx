    ...
    <View className="mt-4 p-2">
      ...
      <View>
        ...
        showsHorizontalScrollIndicator={false}
          ...
          horizontal>
            <Pressable onPress={() => setOpen(true)} ><StyledView
                  className={
        ...
        <View style={{borderBottomWidth:0.35, borderStyle:'solid'}} className='mt-6'>

        </View>
        <Text className='font-bold text-lg text-black-900 mt-2'>Search Results</Text>
      ...
      <LazyLoad
        ...
        options={{limit: 5, query: [['category', '==', selectedCategory]]}}
        updateItems={() => {}}
        content={({item}) => {
